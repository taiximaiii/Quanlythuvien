...
public class QuanLyDocGia extends javax.swing.JFrame {
    ...
    public QuanLyDocGia() {
        ...
        DataFromMySQL.getAndShowData(jTable_DSDocGia, columnTitlesOfJTableDocGia, queryForJTableDocGia);
        showLop();
    }
    ...
    public void themMoiDocGia(String maDG, String tenDG, String gioiTinhDG, String ngaySinhDG,
            String ngayDangKy, String ngayHetHan, String diaChi, String sdt, String email, String maLop) {

        String sql = "insert into NGUOIDUNG(MaNguoiDung,MatKhau,TenNguoiDung, GioiTinh, NgaySinh,NgayDangKy,NgayHetHan, DiaChi,SDT, Email,MaVaiTro,MaLop) values (?,?,?,?,?,?,?,?,?,?,?,?)";
        Connection con = KetNoiSQL.layKetNoi();
        try {
        ...
        if (jDateChooser_NgayHetHan1.getDate().after(jDateChooser_NgayDangKy1.getDate())) {
            ...
            if (maDG.equalsIgnoreCase("")) {
                ...
                if (kiemTraDocGia(maDG) == 1) {
                    ...
                    themMoiDocGia(maDG, chuanHoaDanhTuRieng(tenDG), gioiTinhDG, ngaySinhDG, ngayDangKy, ngayHetHan, diaChi, sdt, email, maLop);
    ...
    public int kiemTraSachMuon(String maDG) {
        Connection con = KetNoiSQL.layKetNoi();
        int tonTai = 0;
        String sql = "select * from PhieuMuon where MANGUOIDUNG ='" + maDG + "'";
        try {
            PreparedStatement ps = con.prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
    ...
    private void jButtonResetPasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonResetPasswordActionPerformed
        ...
        if (selectedRow == -1) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                NguoiDung.updateColumn("MatKhau ", maDocGia, maDocGia);
