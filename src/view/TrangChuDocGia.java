...
public class TrangChuDocGia extends javax.swing.JFrame {
    ...
    public TrangChuDocGia() {
        ...
        // thong ke
        jLabel_SLSach.setText(String.valueOf(DataFromMySQL.aggregate("SELECT SUM(SOLUONGCO) FROM SACH")));
        jLabel_SLSachDangMuon.setText(String.valueOf(DataFromMySQL.aggregate("SELECT COUNT(*) FROM PHIEUMUON WHERE MANGUOIDUNG = '" + maNguoiDung + "'")));
        demSoLuongDG();

        DataFromMySQL.getAndShowData(jTable_DSSach, columnTitlesOfJTableSach, queryForJTableSach);
        String query = "SELECT * "
                + "FROM PHIEUMUON M, SACH S, TACGIA TG, NHAXUATBAN NXB, THELOAI TL "
        ...
        jPanel28Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel28Layout.createSequentialGroup()
                ...
                .addGroup(jPanel28Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jButton_TimSach, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton_ThongBao, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    public void thongBao() {
        ...
        for (int i = 0; i < jTableSachDangMuon.getRowCount(); i++) {
            ...
            if (diffDays >= 0) {
                str += "Sách " + (String) jTableSachDangMuon.getModel().getValueAt(i, 1) + " còn " + diffDays + " ngày nữa hết hạn mượn.\n";
            } else {
                str += "Sách " + (String) jTableSachDangMuon.getModel().getValueAt(i, 1) + " đã hết hạn mượn.\n";
            }
